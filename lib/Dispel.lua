...
Highlights debuffs a player can dispel.

Widget:

  DispelHighlight - An array consisting of up to 3 textures.

Sub-Widgets:

  texture     - Texture to be shown/hidden if a dispelable debuff is found.
                Will be colored according to the debuff type.
  icon        - Texture to hold the icon of the first dispelable debuff found.
  iconOverlay - A border texture for the icon. Will be colored according to
                the debuff type.
